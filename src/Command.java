...
public class Command {
    ...
    public void info(DragonCollection collection) {
    ...
    public void show(DragonCollection collection) {
        System.out.println("Элементы текущей коллекции:");
        for (Dragon dragon : collection.getDragonArray()) {
            System.out.println(dragon);
        }
    }

    public void clear(DragonCollection collection) {
